...
implements Serializable {
    ...
    public Customer(String firstName, String lastName, LocalDate birthDay, Gender gender, Neighberhood neighberhood, boolean isSensitiveToLactose, boolean isSensitiveToGluten) {
    ...
    public Customer(String firstName, String lastName, LocalDate birthDay, Gender gender, Neighberhood neighberhood, boolean isSensitiveToLactose, boolean isSensitiveToGluten, long idNumber) {
        super(idCounter++, firstName, lastName, birthDay, gender);
        this.neighberhood = neighberhood;
        this.isSensitiveToLactose = isSensitiveToLactose;
        this.isSensitiveToGluten = isSensitiveToGluten;
    ...
    public boolean isSensitiveToLactose() {
        return this.isSensitiveToLactose;
    }
    ...
    public boolean isSensitiveToGluten() {
        return this.isSensitiveToGluten;
    }
    ...
    public String toString() {
        return this.getIdNumber() + " ," + this.getFirstName() + " " + this.getLastName() + ", Lactose= " + this.isSensitiveToLactose + ", Gluten= " + this.isSensitiveToGluten;
    }
