...
public class Main {
    ...
    private static Map<String, Section> sections = new HashMap<String, Section>();
    ...
    static {
        ...
        commands.put("space", (section, args) -> MyFileLogWriter.println(""));
        commands.put("finish", (section, args) -> MyFileLogWriter.saveLogFile());
        commands.put("addDeliverArea", (section, args) -> {
            DeliveryArea da;
            HashSet<Neighberhood> n = new HashSet<Neighberhood>();
            ...
            if (rest.addDeliveryArea(da = new DeliveryArea(args[0], n, Integer.parseInt(args[1])))) {
        ...
        commands.put("addDelivery", (section, args) -> {
            ...
            if ((o = rest.getRealOrder(Integer.parseInt(args[4]))) != null) {
                orders.add(o);
            }
            if ((o = rest.getRealOrder(Integer.parseInt(args[5]))) != null) {
                orders.add(o);
            }
            LocalDate deliveredDate = LocalDate.of(Integer.parseInt(args[6]), Integer.parseInt(args[7]), Integer.parseInt(args[8]));
            RegularDelivery d = new RegularDelivery(orders, dp, da, Boolean.parseBoolean(args[2]), deliveredDate);
        ...
        commands.put("getDeliveriesByPerson", (section, args) -> {
            int month;
            DeliveryPerson dp = rest.getRealDeliveryPerson(Integer.parseInt(args[0]));
            TreeSet<Delivery> result = rest.getDeliveriesByPerson(dp, month = Integer.parseInt(args[1]));
            if (result.isEmpty()) {
                MyFileLogWriter.println("No deliveries by this delivery person in month " + month + "\n");
            } else {
        ...
        commands.put("getNumberOfDeliveriesPerType", (section, args) -> {
            ...
            if (result.isEmpty()) {
                MyFileLogWriter.println("Has no deliveries in the system\n");
            } else {
                MyFileLogWriter.println("Has " + result.get("Regular delivery") + " regular deliveries and " + result.get("Express delivery") + " express deliveries\n");
            }
        });
        ...
        commands.put("getPopularComponents", (section, args) -> {
            ...
            if (result.isEmpty()) {
                MyFileLogWriter.println("Has no components in the system\n");
            } else {
        ...
        commands.put("getProfitRelation", (section, args) -> {
            ...
            if (result.isEmpty()) {
                MyFileLogWriter.println("Has no dishs in the system\n");
            } else {
        ...
        commands.put("createAIMacine", (section, args) -> {
            ...
            if ((o = rest.getRealOrder(Integer.parseInt(args[3]))) != null) {
                orders.add(o);
            }
            if ((o = rest.getRealOrder(Integer.parseInt(args[4]))) != null) {
                orders.add(o);
            ...
            if ((result = rest.createAIMacine(dp, da, orders)).isEmpty()) {
                MyFileLogWriter.println("Failed in 'create AI machine' method\n");
            } else {
        ...
        commands.put("removeDeliverArea", (section, args) -> {
            ...
            if (rest.removeDeliveryArea(da, newDA = rest.getRealDeliveryArea(Integer.parseInt(args[1])))) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println("All commands executed. Please check \"output.txt\".");
        }
    }
    ...
    private static interface Command {
        public void execute(Section var1, String ... var2);
    }
}
