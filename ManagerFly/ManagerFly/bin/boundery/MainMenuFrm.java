...
public class MainMenuFrm {
    ...
    void goXmlImport(ActionEvent event) throws IOException {
        Pane root = (Pane)LoadPane.LoadFXML(this.getClass(), "/boundery/ImportFlightStatusFromXML.fxml");
        this.pannelRoot.setCenter((Node)root);
    }

    @FXML
    void goJsonExport(ActionEvent event) throws IOException {
        Pane root = (Pane)LoadPane.LoadFXML(this.getClass(), "/boundery/ExportFlightsData.fxml");
        this.pannelRoot.setCenter((Node)root);
    }
